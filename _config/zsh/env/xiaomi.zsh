...
XIAOMI_MESSAGE_BASE_URL=$MIMO_MESSAGE_BASE_URL
XIAOMI_CHAT_COMPLETION_BASE_URL=$MIMO_CHAT_COMPLETION_BASE_URL
XIAOMI_RESPONSE_BASE_URL=$MIMO_RESPONSE_BASE_URL
